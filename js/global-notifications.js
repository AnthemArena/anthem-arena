...
// ========================================
// FOOTER SHARE CTA BANNER
// ========================================

function initFooterCTA() {
    // Don't show on vote page (would be redundant)
    ...
    banner.className = 'footer-cta-banner';
    banner.innerHTML = `
        <div class="container">
            <div class="cta-content">
                ...
                <div class="cta-actions">
                    <button class="btn-primary share-twitter" onclick="window.shareToTwitter()">
                        Share on Twitter
                    </button>
                    <button class="btn-secondary copy-link" onclick="window.copyShareLink()">
                        Copy Link
                    </button>
                </div>
            </div>
    ...
    console.log('✅ Footer CTA banner injected');
}
...
function injectFooterCTAStyles() {
    if (document.getElementById('footer-cta-styles')) return;
    
    const style = document.createElement('style');
    style.id = 'footer-cta-styles';
    style.textContent = `
/* ========================================
   FOOTER SHARE CTA BANNER
======================================== */
...
@media (max-width: 480px) {
    ...
    document.head.appendChild(style);
    console.log('✅ Footer CTA styles injected');
}
...
function initFooterCTASystem() {
    // Wait for DOM to be ready
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', () => {
            injectFooterCTAStyles();
            // Wait a bit for footer to load
            setTimeout(initFooterCTA, 500);
        });
    } else {
        injectFooterCTAStyles();
        setTimeout(initFooterCTA, 500);
